...
public class Appliance {
    ...
    /**
     * A typical dimension for a typical appliance.
     */
    public static final double DEFAULT_DIMENSION = 75.0;

    /**
     * A typical manufacturer for a typical appliance.
     */
    public static final String DEFAULT_MANUFACTURER = "Acme";

    /**
     * A typical serial number for a typical appliance.
     */
     ...
     * @param serialNumber a String
     * @param heightCentimetres a double
     * @param widthCentimetres a double
     * @param depthCentimetres a double
     */
